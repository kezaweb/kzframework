...
/**
 * Base class that represents a row from the 'bch_rul' table.
 *
 *
 *
 * @package    propel.generator.model.om
 */
abstract class BaseBchRul extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Kzf\\Model\\BchRulPeer';
    ...
    /**
     * The value for the bcr_option field.
     * @var        string
     */
    protected $bcr_option;
    ...
    /**
     * Get the [bcr_option] column value.
     *
     * @return string
     */
    public function getBcrOption()
    {
        return $this->bcr_option;
    }
    ...
    public function setBchId($v)
    {
        ...
        if ($this->bch_id !== $v) {
            $this->bch_id = $v;
            $this->modifiedColumns[] = BchRulPeer::BCH_ID;
        }
    ...
    public function setRulId($v)
    {
        ...
        if ($this->rul_id !== $v) {
            $this->rul_id = $v;
            $this->modifiedColumns[] = BchRulPeer::RUL_ID;
        }
    ...
    /**
     * Set the value of [bcr_option] column.
     *
     * @param string $v new value
     * @return BchRul The current object (for fluent API support)
     */
    public function setBcrOption($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->bcr_option !== $v) {
            $this->bcr_option = $v;
            $this->modifiedColumns[] = BchRulPeer::BCR_OPTION;
        }
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = BchRulPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = BchRulPeer::UPDATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->bch_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 7; // 7 = BchRulPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating BchRul object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aBranch !== null && $this->bch_id !== $this->aBranch->getId()) {
            $this->aBranch = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BchRulPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BchRulQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BchRulPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BchRulPeer::BCH_ID)) {
            $modifiedColumns[':p' . $index++]  = 'bch_id';
        }
        if ($this->isColumnModified(BchRulPeer::RUL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'rul_id';
        }
        if ($this->isColumnModified(BchRulPeer::BCR_OPTION)) {
            $modifiedColumns[':p' . $index++]  = 'bcr_option';
        }
        ...
        $sql = sprintf(
            'INSERT INTO bch_rul (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'rul_id':
                        ...
                        break;
                    case 'bcr_option':
                        $stmt->bindValue($identifier, $this->bcr_option, PDO::PARAM_STR);
                        break;
                    case 'created_by':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BchRulPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BchRulPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BchRul'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BchRul'][serialize($this->getPrimaryKey())] = true;
        $keys = BchRulPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getBchId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setBchId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BchRulPeer::BCH_ID)) $criteria->add(BchRulPeer::BCH_ID, $this->bch_id);
    ...
    {
        $criteria = new Criteria(BchRulPeer::DATABASE_NAME);
        $criteria->add(BchRulPeer::BCH_ID, $this->bch_id);
        $criteria->add(BchRulPeer::RUL_ID, $this->rul_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getBchId()) && (null === $this->getRulId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of BchRul (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BchRul Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aBranch === null && ($this->bch_id !== null) && $doQuery) {
            $this->aBranch = BranchQuery::create()->findPk($this->bch_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBranch->addBchRuls($this);
             */
        }
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addBchRulRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByCreatedBy->addBchRulsRelatedByCreatedBy($this);
             */
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addBchRulRelatedByUpdatedBy($this);
        }
    ...
    public function getUserRelatedByUpdatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUpdatedBy->addBchRulsRelatedByUpdatedBy($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(BchRulPeer::DEFAULT_STRING_FORMAT);
    }
