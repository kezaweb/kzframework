...
abstract class BaseBchRulQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT bch_id, rul_id, bcr_option, created_by, updated_by, created_at, updated_at FROM bch_rul WHERE bch_id = :p0 AND rul_id = :p1';
        try {
    ...
    {
        return $this->addUsingAlias(BchRulPeer::UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(BchRulPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(BchRulPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(BchRulPeer::CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(BchRulPeer::CREATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(BchRulPeer::CREATED_AT);
    }
}
