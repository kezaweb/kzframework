...
use Kzf\Model\map\TemplateTableMap;
...
abstract class BaseTemplatePeer
{
    ...
    const OM_CLASS = 'Kzf\\Model\\Template';
    ...
    /** the column name for the tpl_name field */
    const TPL_NAME = 'template.tpl_name';

    /** the column name for the tpl_desc field */
    const TPL_DESC = 'template.tpl_desc';

    /** the column name for the tpl_file field */
    const TPL_FILE = 'template.tpl_file';
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TemplatePeer::TPL_NAME);
            ...
            $criteria->addSelectColumn($alias . '.tpl_name');
    ...
    public static function doCountJoinUserRelatedByCreatedBy(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(TemplatePeer::CREATED_BY, UserPeer::ID, $join_behavior);
    ...
    public static function doCountJoinUserRelatedByUpdatedBy(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(TemplatePeer::UPDATED_BY, UserPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Template objects pre-filled with their User objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinUserRelatedByCreatedBy(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Template) to $obj2 (User)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Template) to the collection in $obj2 (User)
                $obj2->addTemplateRelatedByCreatedBy($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Template) to the collection in $obj3 (User)
    ...
    /**
     * Selects a collection of Template objects pre-filled with all related objects except UserRelatedByCreatedBy.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of Template objects pre-filled with all related objects except UserRelatedByUpdatedBy.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
