...
use Kzf\Model\map\BranchTableMap;
...
abstract class BaseBranchPeer
{
    ...
    const OM_CLASS = 'Kzf\\Model\\Branch';
    ...
    /** the column name for the bch_title field */
    const BCH_TITLE = 'branch.bch_title';

    /** the column name for the bch_active field */
    const BCH_ACTIVE = 'branch.bch_active';

    /** the column name for the bch_published_at field */
    const BCH_PUBLISHED_AT = 'branch.bch_published_at';

    /** the column name for the bch_level field */
    const BCH_LEVEL = 'branch.bch_level';

    /** the column name for the bch_url field */
    const BCH_URL = 'branch.bch_url';
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BranchPeer::BCH_TITLE);
            $criteria->addSelectColumn(BranchPeer::BCH_ACTIVE);
            $criteria->addSelectColumn(BranchPeer::BCH_PUBLISHED_AT);
            ...
            $criteria->addSelectColumn($alias . '.bch_active');
            $criteria->addSelectColumn($alias . '.bch_published_at');
    ...
    public static function doCountJoinTemplate(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(BranchPeer::TPL_ID, TemplatePeer::ID, $join_behavior);
    ...
    public static function doCountJoinUserRelatedByCreatedBy(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(BranchPeer::CREATED_BY, UserPeer::ID, $join_behavior);
    ...
    public static function doCountJoinUserRelatedByUpdatedBy(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(BranchPeer::UPDATED_BY, UserPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Branch objects pre-filled with their Template objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinTemplate(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Branch) to $obj2 (Template)
                $obj2->addBranch($obj1);
    ...
    /**
     * Selects a collection of Branch objects pre-filled with their User objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Branch objects.
    ...
    public static function doSelectJoinUserRelatedByCreatedBy(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Branch) to $obj2 (User)
                $obj2->addBranchRelatedByCreatedBy($obj1);
    ...
    public static function doSelectJoinUserRelatedByUpdatedBy(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Branch) to $obj2 (User)
                $obj2->addBranchRelatedByUpdatedBy($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Branch) to the collection in $obj2 (Template)
                $obj2->addBranch($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Branch) to the collection in $obj3 (User)
                $obj3->addBranchRelatedByCreatedBy($obj1);
            } // if joined row not null
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (Branch) to the collection in $obj4 (User)
                $obj4->addBranchRelatedByUpdatedBy($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Branch objects pre-filled with all related objects except Template.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptTemplate(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = BranchPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Branch) to the collection in $obj2 (User)
                $obj2->addBranchRelatedByCreatedBy($obj1);
                ...
                // Add the $obj1 (Branch) to the collection in $obj3 (User)
                $obj3->addBranchRelatedByUpdatedBy($obj1);
    ...
    /**
     * Selects a collection of Branch objects pre-filled with all related objects except UserRelatedByCreatedBy.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of Branch objects pre-filled with all related objects except UserRelatedByUpdatedBy.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
