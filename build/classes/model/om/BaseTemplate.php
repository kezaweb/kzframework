...
abstract class BaseTemplate extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Kzf\\Model\\TemplatePeer';
    ...
    /**
     * The value for the tpl_name field.
     * @var        string
     */
    protected $tpl_name;

    /**
     * The value for the tpl_desc field.
     * @var        string
     */
    protected $tpl_desc;

    /**
     * The value for the tpl_file field.
     * @var        string
     */
    protected $tpl_file;
    ...
    /**
     * Set the value of [tpl_name] column.
     *
     * @param string $v new value
     * @return Template The current object (for fluent API support)
     */
    public function setTplName($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->tpl_name !== $v) {
            $this->tpl_name = $v;
            $this->modifiedColumns[] = TemplatePeer::TPL_NAME;
        }
    ...
    /**
     * Set the value of [tpl_desc] column.
     *
     * @param string $v new value
     * @return Template The current object (for fluent API support)
     */
    public function setTplDesc($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->tpl_desc !== $v) {
            $this->tpl_desc = $v;
            $this->modifiedColumns[] = TemplatePeer::TPL_DESC;
        }
    ...
    /**
     * Set the value of [tpl_file] column.
     *
     * @param string $v new value
     * @return Template The current object (for fluent API support)
     */
    public function setTplFile($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->tpl_file !== $v) {
            $this->tpl_file = $v;
            $this->modifiedColumns[] = TemplatePeer::TPL_FILE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->tpl_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 8; // 8 = TemplatePeer::NUM_HYDRATE_COLUMNS.
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->branchsScheduledForDeletion !== null) {
                if (!$this->branchsScheduledForDeletion->isEmpty()) {
                    foreach ($this->branchsScheduledForDeletion as $branch) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TemplatePeer::TPL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'tpl_name';
        }
        if ($this->isColumnModified(TemplatePeer::TPL_DESC)) {
            $modifiedColumns[':p' . $index++]  = 'tpl_desc';
        }
        if ($this->isColumnModified(TemplatePeer::TPL_FILE)) {
            $modifiedColumns[':p' . $index++]  = 'tpl_file';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'tpl_name':
                        $stmt->bindValue($identifier, $this->tpl_name, PDO::PARAM_STR);
                        break;
                    case 'tpl_desc':
                        $stmt->bindValue($identifier, $this->tpl_desc, PDO::PARAM_STR);
                        break;
                    case 'tpl_file':
                        $stmt->bindValue($identifier, $this->tpl_file, PDO::PARAM_STR);
                        break;
                    case 'created_by':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getTplDesc();
                break;
            case 3:
                return $this->getTplFile();
                break;
            case 4:
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setTplName($value);
                break;
            case 2:
                $this->setTplDesc($value);
                break;
            case 3:
                $this->setTplFile($value);
                break;
            case 4:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setTplName($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TemplatePeer::TPL_NAME)) $criteria->add(TemplatePeer::TPL_NAME, $this->tpl_name);
    ...
    {
        $copyObj->setTplName($this->getTplName());
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addTemplateRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUserRelatedByCreatedBy->addTemplatesRelatedByCreatedBy($this);
             */
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addTemplateRelatedByUpdatedBy($this);
        }
    ...
    public function getUserRelatedByUpdatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUpdatedBy->addTemplatesRelatedByUpdatedBy($this);
             */
        }
    ...
    public function setBranchs(PropelCollection $branchs, PropelPDO $con = null)
    {
        ...
        $this->branchsScheduledForDeletion = unserialize(serialize($branchsToDelete));

        foreach ($branchsToDelete as $branchRemoved) {
            $branchRemoved->setTemplate(null);
        }
    ...
    public function removeBranch($branch)
    {
        if ($this->getBranchs()->contains($branch)) {
            ...
            $this->branchsScheduledForDeletion[]= $branch;
            $branch->setTemplate(null);
        }
     ...
     * @return PropelObjectCollection|Branch[] List of Branch objects
     */
    public function getBranchsJoinUserRelatedByCreatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = BranchQuery::create(null, $criteria);
     ...
     * @return PropelObjectCollection|Branch[] List of Branch objects
     */
    public function getBranchsJoinUserRelatedByUpdatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = BranchQuery::create(null, $criteria);
