...
use Kzf\Model\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    /** the column name for the usr_login field */
    const USR_LOGIN = 'user.usr_login';

    /** the column name for the usr_password field */
    const USR_PASSWORD = 'user.usr_password';

    /** the column name for the usr_cp field */
    const USR_CP = 'user.usr_cp';

    /** the column name for the usr_avatar field */
    const USR_AVATAR = 'user.usr_avatar';
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserPeer::USR_FIRST_NAME);
            $criteria->addSelectColumn(UserPeer::USR_LAST_NAME);
            $criteria->addSelectColumn(UserPeer::USR_LOGIN);
            $criteria->addSelectColumn(UserPeer::USR_PASSWORD);
            ...
            $criteria->addSelectColumn($alias . '.usr_login');
