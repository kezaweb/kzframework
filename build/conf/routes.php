...
$routes->add('tree', new Routing\Route('/tree', array('_controller' => 'Kzf\\Controller\\NodeController::listAction')));
...
$routes->add('node', new Routing\Route('/node', array('_controller' => 'Kzf\\Controller\\NodeController::singleAction')));
...
$routes->add('leaves', new Routing\Route('/leaves', array('_controller' => 'Kzf\\Controller\\LeafController::listAction')));
